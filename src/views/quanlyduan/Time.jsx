        ...
        <div className="content">
          <Row>
            ...
            <Col md="12">
              <Card>
                <CardHeader>
                  <CardTitle tag="h4" pull-left>Thời gian theo công việc</CardTitle>
                </CardHeader>
                <CardBody>
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="text-left">Trần Thị Bích Mai</td>
                      ...
                      <tr>
                        ...
                        <td className="text-left">Trần Văn A</td>
                        <td className="text-right">
                          <Button
                            className="btn-icon btn-neutral"
                            color="success"
                      ...
                      <tr>
                        ...
                        <td className="text-left">Nguyễn Thị Thanh Thúy</td>
                        <td className="text-right">
                          <Button
                            className="btn-icon btn-neutral"
                            color="success"
            ...
            <Col>
            <Button className="float-right" color="primary">Thêm thời gian</Button>
            </Col>
          </Row>
        </div>
      </>
